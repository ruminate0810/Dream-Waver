...
// Sprint AF.1 — TOOL_THINKING / pickThinkingPool / getActiveToolName
// extracted to ./thinking-copy so DeckPhaseTimeline can share the same
// rotating active label. Kept the import alias `getActiveToolName` /
// `pickThinkingPool` so the rest of this file reads identically.
import {
  getActiveToolName,
  pickThinkingPool,
} from "./thinking-copy";

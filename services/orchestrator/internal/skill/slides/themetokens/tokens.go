...
var table = map[string]Tokens{
	"minimalist": {Key: "minimalist", BG: "#FFFFFF", FG: "#0F172A", FGMuted: "#64748B", Accent: "#2563EB",
		...
		ImagePalette: "bright white studio, soft daylight, vast negative space, single-subject minimal product photography, cool neutral tones",
		Mood:         "Swiss minimalism — one ink color + one blue accent, hairline rules, vast whitespace; restraint is the design"},

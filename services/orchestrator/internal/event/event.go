...
const (
	...
	KindToolEnd     Kind = "tool.end"     // tool invocation ends
...
func NewToolStart(name, id string) Event {
	return Event{Kind: KindToolStart, Data: EventData{ToolName: name, ToolID: id}}
}

func NewToolEnd(name, id, output, errMsg string) Event {
	return Event{Kind: KindToolEnd, Data: EventData{
		ToolName: name, ToolID: id, ToolOutput: output, Error: errMsg,
	}}
}
